<template>
  <div class="news">
    <div class="news-box" >
      <h3><span class="spn">工作动态</span><img src="/static/images/index/xiangyun.png" alt=""></h3>
...
.news{padding: 30px;box-sizing: border-box;background-color: #fff;width: 67%;
    .news-box{width: 100%;
        ...
        .news-content-box{width: 100%;margin-top: 20px;margin-bottom: 20px;
            ...
            .item{position: relative; width: 100%;display: flex;justify-content:space-between;margin-bottom: 15px;box-sizing: border-box;padding:0 5px 0 12px;align-items: center;
                .item-title{width: 590px;font-size: 16px;color: #3d3d3d;font-weight: 500;overflow: hidden;text-overflow: ellipsis;white-space: nowrap;}
